...
{
    [DbContext(typeof(SimpleStockDbContext))]
    [Migration("20250205234727_modifiDescriptionEn+ArInCategory")]
    partial class modifiDescriptionEnArInCategory
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("SimpleStock.Categories.Category", b =>
                {
                    b.Property<int>("Id")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("SimpleStock.Products.Product", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<string>("DesciptionAr")
                        .IsRequired()
                        .HasMaxLength(1000)
                        .HasColumnType("nvarchar(1000)");

                    b.Property<string>("DesciptionEn")
                        .IsRequired()
                        .HasMaxLength(1000)
                        .HasColumnType("nvarchar(1000)");
            ...
            modelBuilder.Entity("SimpleStock.Products.Product", b =>
                {
                    b.HasOne("SimpleStock.Categories.Category", "Category")
                        .WithMany()
